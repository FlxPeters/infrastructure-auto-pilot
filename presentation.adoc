...
Felix Peters - E. Breuninger GmbH & Co | Engineering Lead OCT
...
image::images/woody.jpg[width=1000px]
...
* Jedes Projekt ist ein Stein darin und macht euch langsamer
--

image::images/onedoesnot.jpg[]
...
[.note]
--
Frage - Wer hat eine idee wie wir das lösen?
--
...
* Konfigurierbar (z.B. nach Package Typ, Timing, etc.)
* Auto-Merge

[%step]
**Das bedingt Vertrauen in deinen Code und Automatisierung!**
